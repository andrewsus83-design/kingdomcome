...
const _blueprints = [
  _Blueprint(
    ...
    requiredBuildings: {
      ...
      BuildingType.scriptorium: 3,
      BuildingType.bellTower: 2,
    },
    woodCost: 500,
    goldCost: 1000,
    stoneCost: 750,
  ...
  _Blueprint(
    ...
    requiredBuildings: {BuildingType.chapel: 1},
    woodCost: 50,
    goldCost: 100,
    stoneCost: 30,
  ...
  _Blueprint(
    ...
    requiredBuildings: {
      BuildingType.scriptorium: 2,
      BuildingType.bellTower: 1,
    },
    woodCost: 300,
    goldCost: 200,
    stoneCost: 150,
